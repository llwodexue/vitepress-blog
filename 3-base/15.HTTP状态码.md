...
- 303 See Other。表示由于请求对应的资源存在着另一个URI，应用 GET 方法定向获取请求的资源
...
- 406 Not Acceptable。内容协商，客户端与服务端协商需要什么样的资源，比如语言（中文/英文）`Accept-Language`、压缩编码 `Accept-Encoding` 以及媒体类型，如果服务器无法返回对应的资源
