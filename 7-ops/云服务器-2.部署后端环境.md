...
- 由于我使用的是 Alibaba Cloud Linux 3.2104 LTS 64位，就安装了 java-17-alibaba-dragonwell

```bash
# 查询一下都有哪些 java-17 版本
$ dnf search java-17
# 根据提示的版本进行挑选下载
$ dnf install java-17-alibaba-dragonwelll.x86_64
```

如果下载的非最新版 Jenkins 可以安装 Java 1.8 版本
