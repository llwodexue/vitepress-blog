...
class App extends React.Component {
  ...
  render() {
    ...
    // 1.React 元素: 通过 JSX 编写的代码就会被编译成 React.createElement,
...
- 当然，如果你在项目中默认集成了 Flow 或者 TypeScript，那么直接就可以进行类型验证
...
// 3.第三步操作: 设置组件的 contextType 为某一个 Context
